    ...
    <AppSafeAreaView>
      ...
      <KeyBoardAware>
        <AppText type={SIXTEEN} weight={SEMI_BOLD} style={styles.title}>
          Pay trading fees with coinpower Exchange
        </AppText>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.infoContainer}>
            ...
            <AppText type={TEN}>coinpower Exchange buy from the exchange</AppText>
          </View>
          <View style={styles.infoContainer}>
            <View style={styles.indicator} />
            <AppText type={TEN}>
              Unlocked coinpower Exchange balance reserved for trading fees
            </AppText>
          </View>
        ...
        <View style={[styles.container, styles.note]}>
          <AppText>
            Based on your coinpower Exchange holdings at the time of the trade, your
            trading fee rate will be determined as follows :
          </AppText>
          <View style={styles.fillContainer}>
            <View style={styles.fillHeading}>
              <AppText type={FOURTEEN}>coinpower Exchange holdings</AppText>
            </View>
            <View style={styles.fillHeading}>
