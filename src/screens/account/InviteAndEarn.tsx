...
const InviteAndEarn = () => {
  ...
  let coinpowerPrice = coinData?.filter((pair) => pair?.base_currency === 'USDT' && pair?.quote_currency === 'coinpower')[0]?.buy_price;
  let totalReward = coinData?.filter((item) => item?.coinpower_reward == "true")?.length;
  useEffect(() => {
  ...
  return (
    <AppSafeAreaView>
      ...
      <KeyBoardAware>
        ...
        <AppText>
        Earn upto 40% of the commission fee generated by your invites.
        </AppText>
        <View style={{flexDirection: "column", justifyContent: "space-around", alignItems: "center"}}>
        <AppText type={TWENTY_SIX} color={YELLOW} weight={BOLD}>
        {coinpowerPrice} coinpower
        </AppText>
        ...
        <View style={styles.container}>
          {/* <View style={styles.balanceContainer}>
            ...
            {twoFixedTwo(totalReward * coinpowerPrice * 2)} coinpower
            </AppText>
          </View> */}
